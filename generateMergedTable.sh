...
#SBATCH --mail-user=musarrat.amin-1@ou.edu
#SBATCH --mail-type=ALL
#SBATCH --chdir=/home/himi/RNAseqAnalysis-
#
# script to generate guide file and merge gene counts using the merge_tables.py script
# usage: bash generateMergedTable.sh inputsFile outputsFile
# usage ex: bash generateMergedTable.sh /scratch/himi/analysis/counted /scratch/himi/analysis
# usage ex: bash generateMergedTable.sh /YOUR/PATH/Jurkat/counted /YOUR/PATH/Jurkat
