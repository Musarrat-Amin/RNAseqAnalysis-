...
# usage: sbatch fastqc.sh readPath outputsPath
# usage Ex: sbatch fastqc.sh /scratch/bhavani/GBCF_Data/Adipocyte/220705_Yoon_Adipocyte_Pool2_RNAseq /scratch/himi/analysis
