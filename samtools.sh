...
# usage: sbatch samtools.sh inputsFile outputsFile
# usage Ex: sbatch samtools.sh /scratch/himi/analysis/alined/scratch/himi/analysis
# usage Ex: sbatch samtools.sh /YOUR/PATH/jurkat/aligned /YOUR/PATH/jurkat
